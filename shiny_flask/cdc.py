...
def server(input, output, session):
    ...
    def avg_data_value():
        ...
        return f"Average Depression Drinking Age-adjusted Prevalence for {selected_county}: {avg_value:.2f}%"

    @output
    @render.plot(alt="Depression Drinking Age-adjusted Prevalence Bar Chart")
    def bar_chart():
        ...
        ax.set_ylim(0, 30)
        ax.set_title('Depression Drinking Age-adjusted Prevalence Comparison')
